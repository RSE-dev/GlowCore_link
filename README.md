...
Transmit the 32-bit word using the device firmware's defined byte/bit order. The checksum covers the lower 28 bits, from `ProtocolVersion` through `MessageValue`.
